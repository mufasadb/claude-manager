...
import { Folder, Plug, Fish } from 'lucide-react';
  ...
  return (
    <div id="projectScopeContent" className="sections">
      <div className="scope-section">
        <div className="scope-header"><Folder size={16} style={{ marginRight: '8px' }} />Project: {selectedProject}</div>
      ...
      <div className="scope-section">
        <div className="scope-header"><Plug size={16} style={{ marginRight: '8px' }} />Project MCP Servers</div>
        <div className="scope-content">
          <MCPManagement 
            scope="project"
            projectPath={project.path}
      ...
      <div className="scope-section">
        <div className="scope-header"><Fish size={16} style={{ marginRight: '8px' }} />Project Hook Events</div>
        <div className="scope-content">
          <HookManagement 
            scope="project"
